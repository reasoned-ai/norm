...
Revision ID: d3545671fa7f
Revises: 
Create Date: 2019-03-11 01:47:29.036752
...
def upgrade():
    ...
    sa.Column('level', sa.Enum('COMPUTABLE', 'QUERYABLE', 'ADAPTABLE', name='level'), nullable=True),
